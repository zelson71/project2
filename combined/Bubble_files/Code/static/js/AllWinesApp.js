...
// })
    ...
    function buildScatterPlot(data){
        ...
        for (var i=0; i < data.length; i++) {
            var hover = `<b>${Title[i]}</b><br><br><b>Varietal:</b> ${Varietal[i]}<br><b>Type:</b> ${Category[i]}<b><br>Country:</b> ${Country[i]}<br><b>Vintage:</b> ${Vintage[i]}<br><b>Rating:</b> ${Rating[i]}<br><b>Price:</b> $${Price[i]}`
            // <br><b>Review:</b> ${URL[i]}
    ...
    // listIDs = {VinList: selVintage, PriceList: selPrice, RatingList: selRating, CountryList2: selCountry }
